...
power_2d$Global_reactive_power <- as.numeric(power_2d$Global_reactive_power)
power_2d$Voltage <- as.numeric(power_2d$Voltage)
...
with(power_2d, plot(timestamp, Voltage, type = "l", 
                    main = "", 
                    xlab = "", 
                    ylab = "Voltage"))
...
with(power_2d, plot(timestamp, Global_reactive_power, type = "l", 
                    main = "", 
                    xlab = "", 
